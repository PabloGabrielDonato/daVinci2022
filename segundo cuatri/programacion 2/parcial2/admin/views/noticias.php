    ...
    <table class="table">
		...
		?>
            <tr>
                ...
                <td><img src="<?= '../imgs/' . htmlspecialchars($noticia->getImagen());?>"
                        alt="<?= htmlspecialchars($noticia->getImagenDescripcion());?>"></td>
                <td>
                    <a href="index.php?s=noticias-editar&id=<?= $noticia->getNoticiaId();?>" class="button">Editar</a>
                    <a href="index.php?s=noticias-eliminar&id=<?= $noticia->getNoticiaId();?>"
                        class="button button-error">Eliminar</a>
